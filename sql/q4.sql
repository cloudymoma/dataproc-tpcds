-- TPC-DS Query 4: Find customers who spend more money via catalog than in stores.
-- Identify their preferred store and how they changed their preferences.
...
WITH year_total AS (
    ...
    SELECT
        ...
        c_email_address customer_email_address,
        d_year dyear,
        SUM(cs_ext_list_price - cs_ext_discount_amt) year_total,
        'c' sale_type
